...
export const doctoraliaReviewsLink: string =
  "https://www.doctoralia.com.br/lorenza-arruda/nutrologo/belo-horizonte#profile-reviews";
...
export const address: string =
  "R. Paracatu, 1154 - sala 406 - Santo Agostinho, Belo Horizonte - MG";
export const instagramLink: string =
  "https://www.instagram.com/dralorenzaarruda/";
export const scheduleAnAppointmentLink: string =
  "https://www.doctoralia.com.br/lorenza-arruda/nutrologo/belo-horizonte";
export const websiteCreatorsLink: string =
