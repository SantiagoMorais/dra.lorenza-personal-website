    ...
    return (
        <Container>
            ...
            <div className="contentPage">
                ...
                <p className="warningText">Essa página não existe. Confira novamente o caminho da sua URL ou, por favor, entre em contato conosco caso considere que isso seja um erro.</p>
...
const Container = styled.section`
    ...
    .contentPage {
        ...
        .returnButton {
            ...
            .returnIcon {
                transition: scale .3s, transform .5s;
            }
        }
    }
