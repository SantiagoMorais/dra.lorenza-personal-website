                        ...
                        <li
                            ...
                            <div className="questionBar" data-testid="question">
                                <p className="question">
                                    <span className="questionNumber">{index + 1}.</span> {faq.question}
                                </p>
                                <FontAwesomeIcon icon={faChevronDown} className={`icon ${questionSelected === faq.question && "rotate"}`} />
                            </div>
                            <p className={`answer ${questionSelected === faq.question ? "selected" : ''}`} data-testid="answer">
                                {faq.answer}
                            </p>
                        </li>
                    )}
    ...
    .faqs {
        ...
        .faq {
            ...
            .questionBar {
                font-size: 2.5rem;
                padding-bottom: 1rem;
                border-bottom: .2rem solid ${style.tertiaryColor};
                transition: .3s;
                display: flex;
                align-items: center;
