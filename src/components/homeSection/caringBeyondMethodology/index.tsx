  ...
  const caringBeyondMethodology: ICaringBeyondMethTopic[] = [
    {
      ...
      explanation:
        "Detalhe da dieta atual, identificação de hábitos prejudiciais e estratégias personalizadas.",
      image: caringBeyondTopic1,
    },
    {
      title: "Atividade Física e Sono Reparador",
      explanation:
        "Avaliação de atividade física, suplementação e estratégias para melhorar o sono.",
      image: caringBeyondTopic2,
    },
    {
      title: "Gestão de Ansiedade e Educação da Vontade",
      explanation:
        "Técnicas de relaxamento, estratégias para gerenciar a ansiedade e desenvolver novos hábitos.",
  ...
  return (
    <Container id="methodology">
      <div className="content">
        <h2 className="title">Nossa Abordagem: Cuidar Além</h2>
        <p className="description">
          A Metodologia "Cuidar Além" é baseada em uma abordagem integral que
          abrange avaliação nutricional, física, mental e emocional.
        </p>
        <div className="info">
          <div className="methodologyDescription">
            <h3 className="subtitle">Bases para uma Vida Plena</h3>
            <ul className="topics">
              {caringBeyondMethodology.map((item, index) => (
                <li key={item.title} className="topicItem">
                  ...
                  />
                  <div className="info">
                    <h4 className="topicTitle">{item.title}</h4>
      ...
      .methodologyDescription {
        ...
        .topics {
          ...
          .topicItem {
            ...
            border-radius: 1rem;
            overflow: hidden;
            border: ${style.textColor} solid 0.2rem;
            transition: 0.5s;
            cursor: default;
            position: relative;
            ...
            .topicImage {
              ...
              height: 30rem;
              object-fit: cover;
              border-bottom: ${style.textColor} solid 0.2rem;
              width: 100%;
            }
