...
export const Treatments = () => {
  ...
  const treatmentsData = [
    ...
    {
      id: 2,
      description: "Composição corporal (bioimpedância)",
      image: image2,
    },
    ...
    {
      id: 5,
      description: "Consultas de suplementação e intervenção medicamentosa",
      image: image5,
    },
  ];
  ...
  return (
    <Container>
      ...
      <h3 className="subtitle">Consultas presenciais e teleatendimento</h3>
      <CarouselSlides
        info={treatmentsData}
        slidesNumber={2}
        imagesHeightInRem={30}
        spaceBetween={spaceBetweenCarousel}
      />
