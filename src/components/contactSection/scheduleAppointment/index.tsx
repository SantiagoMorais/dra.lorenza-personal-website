    ...
    <Container id="contact">
      <div className="content">
        <div className="info instagram">
          <h2 className="title">
            Gostaria de explorar uma variedade maior de conteúdos sobre
            nutrologia?
          </h2>
        ...
        <div className="info">
          ...
          <p className="text">
            Agende uma consulta hoje mesmo e descubra como podemos ajudar você a
            alcançar uma vida plena e saudável
          </p>
          <p className="text">
            Entre em contato: <br />
            {phoneNumberInString} ou faça sua reserva aqui mesmo.
          </p>
          <Button
            href={whatsAppLink}
            icon={faCalendarDays}
